...
│   ├── CanonRegistry.sol   # Main registry contract
│   ├── MaskSBT.sol         # Soulbound token contract
│   └── interfaces/         # Contract interfaces
├── test/                   # Foundry tests
│   ├── CanonRegistry.t.sol
│   ├── MaskSBT.t.sol
│   ├── CanonRegistry.invariant.t.sol
│   └── MaskSBT.invariant.t.sol
├── echidna/                # Echidna property tests
│   ├── CanonRegistry.echidna.sol
│   └── MaskSBT.echidna.sol
