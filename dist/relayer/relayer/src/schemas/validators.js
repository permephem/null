...
export async function validateWarrantWithCrypto(warrant) {
    try {
...
export async function validateAttestationWithCrypto(attestation) {
    try {
        // Basic schema validation
...
export function validateSubjectTag(subjectTag, controllerKey, subjectDID, context) {
    try {
