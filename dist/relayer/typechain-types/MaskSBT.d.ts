...
export interface MaskSBTInterface extends Interface {
    getFunction(nameOrSignature: "ADMIN_ROLE" | "DEFAULT_ADMIN_ROLE" | "MINTER_ROLE" | "approve" | "balanceOf" | "burnReceipt" | "getApproved" | "getMintTimestamp" | "getOriginalMinter" | "getReceiptHash" | "getRoleAdmin" | "grantRole" | "hasRole" | "isApprovedForAll" | "isReceiptMinted" | "mintReceipt" | "mintTimestamps" | "name" | "originalMinter" | "ownerOf" | "pause" | "paused" | "receiptHashes" | "renounceRole" | "revokeRole" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "sbtMintingEnabled" | "setApprovalForAll" | "supportsInterface" | "symbol" | "toggleSBTMinting" | "toggleTransfer" | "tokenURI" | "totalBurned" | "totalMinted" | "totalSupply" | "transferEnabled" | "transferFrom" | "unpause"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "Approval" | "ApprovalForAll" | "Paused" | "ReceiptBurned" | "ReceiptMinted" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "SBTMintingToggled" | "Transfer" | "TransferToggled" | "Unpaused"): EventFragment;
...
export interface MaskSBT extends BaseContract {
    ...
    getFunction(nameOrSignature: "burnReceipt"): TypedContractMethod<[tokenId: BigNumberish], [void], "nonpayable">;
    getFunction(nameOrSignature: "getApproved"): TypedContractMethod<[tokenId: BigNumberish], [string], "view">;
    getFunction(nameOrSignature: "getMintTimestamp"): TypedContractMethod<[tokenId: BigNumberish], [bigint], "view">;
    getFunction(nameOrSignature: "getOriginalMinter"): TypedContractMethod<[tokenId: BigNumberish], [string], "view">;
    getFunction(nameOrSignature: "getReceiptHash"): TypedContractMethod<[tokenId: BigNumberish], [string], "view">;
    ...
    getFunction(nameOrSignature: "isReceiptMinted"): TypedContractMethod<[receiptHash: BytesLike], [boolean], "view">;
    getFunction(nameOrSignature: "mintReceipt"): TypedContractMethod<[
        to: AddressLike,
        receiptHash: BytesLike
    ], [
        bigint
    ], "nonpayable">;
    getFunction(nameOrSignature: "mintTimestamps"): TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
    getFunction(nameOrSignature: "name"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "originalMinter"): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
    getFunction(nameOrSignature: "ownerOf"): TypedContractMethod<[tokenId: BigNumberish], [string], "view">;
    getFunction(nameOrSignature: "pause"): TypedContractMethod<[], [void], "nonpayable">;
    getFunction(nameOrSignature: "paused"): TypedContractMethod<[], [boolean], "view">;
    getFunction(nameOrSignature: "receiptHashes"): TypedContractMethod<[arg0: BigNumberish], [string], "view">;
    ...
    getFunction(nameOrSignature: "toggleSBTMinting"): TypedContractMethod<[enabled: boolean], [void], "nonpayable">;
    getFunction(nameOrSignature: "toggleTransfer"): TypedContractMethod<[enabled: boolean], [void], "nonpayable">;
    ...
    getEvent(key: "ReceiptBurned"): TypedContractEvent<ReceiptBurnedEvent.InputTuple, ReceiptBurnedEvent.OutputTuple, ReceiptBurnedEvent.OutputObject>;
    getEvent(key: "ReceiptMinted"): TypedContractEvent<ReceiptMintedEvent.InputTuple, ReceiptMintedEvent.OutputTuple, ReceiptMintedEvent.OutputObject>;
    getEvent(key: "RoleAdminChanged"): TypedContractEvent<RoleAdminChangedEvent.InputTuple, RoleAdminChangedEvent.OutputTuple, RoleAdminChangedEvent.OutputObject>;
    getEvent(key: "RoleGranted"): TypedContractEvent<RoleGrantedEvent.InputTuple, RoleGrantedEvent.OutputTuple, RoleGrantedEvent.OutputObject>;
    getEvent(key: "RoleRevoked"): TypedContractEvent<RoleRevokedEvent.InputTuple, RoleRevokedEvent.OutputTuple, RoleRevokedEvent.OutputObject>;
    getEvent(key: "SBTMintingToggled"): TypedContractEvent<SBTMintingToggledEvent.InputTuple, SBTMintingToggledEvent.OutputTuple, SBTMintingToggledEvent.OutputObject>;
    getEvent(key: "Transfer"): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    getEvent(key: "TransferToggled"): TypedContractEvent<TransferToggledEvent.InputTuple, TransferToggledEvent.OutputTuple, TransferToggledEvent.OutputObject>;
    ...
    filters: {
        ...
        "ReceiptBurned(uint256,bytes32,address,uint256)": TypedContractEvent<ReceiptBurnedEvent.InputTuple, ReceiptBurnedEvent.OutputTuple, ReceiptBurnedEvent.OutputObject>;
        ReceiptBurned: TypedContractEvent<ReceiptBurnedEvent.InputTuple, ReceiptBurnedEvent.OutputTuple, ReceiptBurnedEvent.OutputObject>;
        "ReceiptMinted(uint256,bytes32,address,address,uint256)": TypedContractEvent<ReceiptMintedEvent.InputTuple, ReceiptMintedEvent.OutputTuple, ReceiptMintedEvent.OutputObject>;
        ReceiptMinted: TypedContractEvent<ReceiptMintedEvent.InputTuple, ReceiptMintedEvent.OutputTuple, ReceiptMintedEvent.OutputObject>;
        ...
        "SBTMintingToggled(bool)": TypedContractEvent<SBTMintingToggledEvent.InputTuple, SBTMintingToggledEvent.OutputTuple, SBTMintingToggledEvent.OutputObject>;
        SBTMintingToggled: TypedContractEvent<SBTMintingToggledEvent.InputTuple, SBTMintingToggledEvent.OutputTuple, SBTMintingToggledEvent.OutputObject>;
        "Transfer(address,address,uint256)": TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
        Transfer: TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
        "TransferToggled(bool)": TypedContractEvent<TransferToggledEvent.InputTuple, TransferToggledEvent.OutputTuple, TransferToggledEvent.OutputObject>;
        TransferToggled: TypedContractEvent<TransferToggledEvent.InputTuple, TransferToggledEvent.OutputTuple, TransferToggledEvent.OutputObject>;
